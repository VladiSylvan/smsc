<template>
  <nav class="navigation">
    ...
    <div class="navi-head">
      ...
      <span v-if="title === 'Dashboard'">
        <select :style="{ backgroundImage: 'url(' + require('@/assets/Icon/Arrow/Down.svg') + ')' }" name="System" class="system">
          <option value="Overall system">Overall system</option>
        </select>
        <select :style="{ backgroundImage: 'url(' + require('@/assets/Icon/Arrow/Down.svg') + ')' }" name="Days" class="days">
