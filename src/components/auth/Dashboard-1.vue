<template>
    <div class="container">
      <nav class="navigation">
        ...
        <div v-if="popup" v-on:click="popup = !popup" class="popup-menu">
          <div class="username-popup">Linnie Weaver</div>
          <div class="circle"><span id="avatar">A</span></div>
          <img class="popup-image-box" src="@/assets/Icon/Users.svg">
          <span v-if="show" id="popup-link">Profile</span>
          <img class="popup-image-box" src="@/assets/Icon/Settings.svg">
          <span v-if="show" id="popup-link">Settings</span>
          <div v-if="show" class="popup-title">
            Switch to
          </div>
          ...
          <span v-if="show" id="popup-link">Reseller Portal</span>
          <img class="popup-image-box" src="@/assets/Icon/Companies.svg">
          <span v-if="show" id="popup-link">Appolo Inc.</span>
          <div class="popup-logout">
            <img class="popup-image-box" src="@/assets/Icon/Arrow/Right.svg">
            <span v-if="show" id="popup-link">Log out</span>
          </div>
        </div>
      </nav>
