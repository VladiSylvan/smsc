    ...
    <div class="container">
      <nav class="navigation">
        <div class="logo-place">
          <div :style="{ backgroundImage: 'url(' + require('@/assets/Icon/Arrow/Left.svg') + ')' }" class="circle"></div>
