<template>
    <div class="container">
      ...
      <div class="main-add">
        ...
        <router-link :to="{ name: 'ImportDID'}"><button id="product" type="submit">Import DID</button></router-link>
        ...
        <div class="add-did">
          <div class="did-main">
            ...
            <div class="grid-4">
              ...
              <input class="grid-input" type="text" v-model="user.verificationNumber" placeholder="3561">
            </div>
          </div>
        </div>
      </div>
