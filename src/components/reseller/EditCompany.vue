<template>
    <div class="container">
      ...
      <div class="main-add">
        ...
        <router-link :to="{ name: 'ResellerEditCompany'}"><button id="product" type="submit">Save Company</button></router-link>
        <router-link :to="{ name: 'ResellerCompanies'}"><button id="cancel" type="submit">Cancel</button></router-link>
