<template>
    <div class="container">
      <reseller-navigation-component title="SMS Center"></reseller-navigation-component>
      <div class="main">
        <div class="res-div">
        ...
        <div class="messages">
          <div class="new-message">
            ...
            <router-link :to="{ name: 'ResellerSMSCenterNew' }">
        ...
        <div class="chat">
          <div class="chat-input">
            <div v-if="users" class="chat-menu">
              ...
              <router-link :to="{ name: 'ResellerSMSCenterEmpty' }">
