<template>
    <div class="container">
      <staff-navigation-component title="SMS Center"></staff-navigation-component>
      <div class="main">
        <div class="res-div">
        ...
        <div class="messages">
          <div class="new-message">
            ...
            <router-link :to="{ name: 'StaffSMSCenterNew' }">
        ...
        <div class="chat">
          <div class="chat-input">
            <div v-if="users" class="chat-menu">
              ...
              <router-link :to="{ name: 'StaffSMSCenterEmpty' }">
...
import StaffNavigationComponent from '@/components/StaffNavigationComponent'
...
.chat{
  max-width: calc(73.6842105263% - 40px);
  width: 100%;
  float: right;
  display: inline-block;
  margin-top: 20px;
